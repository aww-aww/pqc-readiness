...
| Futurex Vectera Plus | 7.8+ / 8.0+ | 🟢 Ready | FIPS 140-2 Level 3 and PCI HSM v3 / FIPS 140-3 Level 3 and PCI HSM v4 | ML-DSA, ML-KEM, SLH-DSA, LMS, HSS, XMSS	|
General purpose HSM platform for enterprise cryptography, PKI, CA, code signing, and key management use cases. Supports HSM-backed PQC and hybrid certificate authority workflows, hybrid classical/PQC migration modes, PKCS#11 v3.2 PQC mechanisms, Microsoft CNG/KSP integration for Windows Server 2025, and tested interoperability with common PQC libraries. |
